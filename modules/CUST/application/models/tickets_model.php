...
class Tickets_model extends Model{
    ...
    public function getTickets(){
        ...
        $get_all_tickets = $this->db->query("SELECT viv_cust_servs_en.*, viv_emp_en._emp_name FROM viv_cust_servs_en, viv_emp_en WHERE viv_cust_servs_en._cust_servs_tckt_holder = viv_emp_en._emp_email AND viv_cust_servs_en._cust_servs_tckt_sts = 1 ORDER BY _cust_servs_tckt_addedon DESC LIMIT $pc,15");

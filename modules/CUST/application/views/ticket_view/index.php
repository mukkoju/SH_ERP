<div class="span9 cstmr_layout">
    ...
    <div class="shw-tckt">
        ...
        <div class="shw-tckt-opndby"  data-ownreml='<?= $viewTicket[0][0]['_cust_servs_tckt_holder']?>'><b><?= $viewTicket[0][0]['_emp_name']?></b> opened this ticket on <?= date('M j Y', $viewTicket[0][0]['_cust_servs_tckt_addedon'])?></div>
        </div>
        <div class="tckt-bdy">
            ...
            <div class="tckt-desc">
                <div class="tckt-desc-hdr"><b><?= $viewTicket[0][0]['_emp_name']?></b></div>
        ...
        <div class="cmnt-sctn">
            ...
            <div class="old-cmnts">
                <?php $mail = $viewTicket[2][$i]['_servs_cmnts_tckt_cmntby']; 
                ...
                <div class="comnt_old_inpt">
                    <div class="comnt_old_hdr"><b><?= $viewTicket[2][$i]['_emp_name']?></b><span class="cmntd_on"> Commented on <?= date("M j Y", $viewTicket[2][$i]['_servs_cmnts_tckt_cmnton'])?></span></div>
            ...
            <div class="comnt-prfle-img"><?php if(!file_exists("$profileimg/$flnme")){ ?><img src="/images/avtr.jpg"><?php } else {  ?><img src="/uploads/<?php echo $email?>/profile_pic/<?php echo $flnme?>"><?php }?></div>
            <div class="comnt_inpt">
                <div class="comnt_hdr"><b><?= $_SESSION['loggedInName']?></b></div>
